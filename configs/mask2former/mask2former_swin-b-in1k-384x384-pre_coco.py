_base_ = [
    '../_base_/default_runtime.py', '../_base_/datasets/coco-stuff164k.py'
]

pretrained = '/mnt/work_dirs/swin_base_patch4_window12_384_20220317-55b0104a.pth'  # noqa
