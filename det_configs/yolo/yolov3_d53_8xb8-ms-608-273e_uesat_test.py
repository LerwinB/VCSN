...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/uesat_detection_coco.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/uesat_detection_coco_minival.json',
        data_prefix=dict(img='images/minival/'),
        test_mode=True,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'annotations/uesat_detection_coco_minival.json',
    metric='bbox',
    backend_args=backend_args)
