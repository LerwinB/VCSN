...
def parse_args():
    ...
    parser.add_argument('coco_path', default= "coco_164k",help='coco stuff path')
    parser.add_argument('-o', '--out_dir',default= "coco_164k", help='output path')
    parser.add_argument(
...
def main():
    ...
    coco_path = "/home/buaa22/Software/zhaoshengyun/ALSAM/data/coco164k"
    nproc = 16
