...
poses_test = poses.loc[0:nr_testing_images]
poses_val = poses.loc[nr_testing_images:nr_nontraining_images]
poses_train = poses.loc[nr_nontraining_images:nr_images]
