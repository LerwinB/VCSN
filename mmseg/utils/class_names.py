...
def uesat_classes():
    return [
        'background', 'panel', 'aerial','spout','camera','panel support','star sensor','docking','body','arm','part','rodaerial','unkown aerial','others'
    ]

def uesat_palette():
    return [
        [0, 0, 0], [255, 0, 0], [0, 255, 0],[255, 255, 0],[0, 0, 255],[255, 0, 255],[0, 0, 124],[202, 202, 202],[255, 255, 255],[124, 0, 0],[0, 124, 0],[124, 124, 0],[0, 124, 124],[0, 255, 255]
    ]
